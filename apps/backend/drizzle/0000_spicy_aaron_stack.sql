CREATE TYPE "public"."account_type" AS ENUM('savings', 'checking', 'credit');--> statement-breakpoint
CREATE TYPE "public"."currency" AS ENUM('USD', 'EUR', 'GBP', 'COP');--> statement-breakpoint
